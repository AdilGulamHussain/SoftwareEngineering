...
public class Customer {
    ...
    private StringProperty type;
                ...
                this.spcName = new SimpleIntegerProperty(rs.getString("Name"));
            this.spcPostcode = new SimpleIntegerProperty(rs.getString("Postcode"));
            this.spcAddress = new SimpleFloatProperty(rs.getString("TotalCost"));
            this.spcPhone = new SimpleFloatProperty(rs.getString("Phone Number:"));
            this.spcEmail = new SimpleFloatProperty(rs.getString("spcEmail"));
