...
public class EditOrderController implements Initializable {
    ...
    {
        orderPartID1.setText(selected2.getPartID().toString());
        expDel1.setText(selected2.getExpectedDate());
        quantity1.setText(selected2.getQuantity().toString());
    }
    @FXML
    public void confirm2 (ActionEvent event) {
        try {
            ...
            try {
                Integer.parseInt(orderPartID1.getText());
                Double.parseDouble(quantity1.getText());
            }
