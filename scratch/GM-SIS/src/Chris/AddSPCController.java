    ...
    public void addSPC(ActionEvent event)
    {
        try {
            if (!isAdmin) {//need to test if admin
                ...
                String stmt = "INSERT INTO SPC (spcName, spcPostcode, spcAddress, spcPhone, spcEmail) VALUES ('" + spcName.getText() + "','" + spcPostcode.getText() + "', '" + spcAddress.getText() + "', '" + spcPhone.getText() + "', '" + spcEmail.getText() +"');";
                db.update(stmt);
